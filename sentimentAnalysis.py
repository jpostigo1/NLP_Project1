...
# # My comment: Sorts words by frequency
...
s1_set = sentim_analyzer.apply_features(s1_words, labeled=False)

s2 = "The restaurant serves Italian food. They have seven employees."
s2_words = word_tokenize(s2)

print(sentim_analyzer.classify(s2_words))